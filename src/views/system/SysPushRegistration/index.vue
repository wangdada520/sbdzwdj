  ...
  <div class="content">
    <div class="global_table_box">
      ...
      >
        ...
        <el-table-column align="left" prop="mpsPushUrl" label="推送地址" :show-overflow-tooltip="true" />
        <el-table-column align="left" prop="mpsWebUrl" label="web地址" :show-overflow-tooltip="true" />
        <el-table-column align="left" prop="mpsAppUrl" label="app地址" :show-overflow-tooltip="true" />
        <el-table-column align="left" prop="mpsSetName" label="注册编码" :show-overflow-tooltip="true" />
...
<script>
import { getmessagePushSetlist, deletemessagePushSet } from '../../../api/SysPushRegistration'
import Edit from './model/edit'
import Details from './model/details'

export default {
  name: 'SysPushRegistration',
  components: {
    Edit,
    Details
  },
  ...
  methods: {
    ...
    handleDelete(id) {
      ...
      this.$confirm('确定要删除吗?', '提示', {
        ...
        deletemessagePushSet(id, data).then((res) => {
          this.loading = false
          if (res.code === 200) {
            this.$message('删除成功')
            this.getList()
