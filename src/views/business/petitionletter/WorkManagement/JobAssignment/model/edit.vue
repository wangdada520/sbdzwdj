        ...
        <el-row type="flex" class="row-bg" justify="space-between">
          <el-col :span="24">
            <el-form-item label="发生地">
              <el-input v-model="thisform.taskRecord.petitionPlace" placeholder="请输入内容" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg" justify="space-between">
...
export default {
    ...
    return {
      ...
      thisform: {
        ...
        taskRecord: {
          ...
          type: '3' // 业务类型（0：领导批示，1：重点工作，2：会议纪要，3：信访，4：民意快线，5：建议提案）
        },
        type01: '',
        type02: '',
        type03: ''
  ...
  mounted() {
    ...
    this.getByDictCode('xfly', 'options1')
    this.getByDictCode('workType3', 'options3')
  },
  methods: {
    /**
     * 保存并派发
