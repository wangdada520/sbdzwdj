...
<script>
import TableHeader from '@/views/business/publicopinion/components/TableHeader'
import ReportTable from '@/views/business/publicopinion/components/ReportTable'
