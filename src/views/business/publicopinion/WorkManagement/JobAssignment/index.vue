  ...
  <div class="content">
    <div class="global_table_box">
      ...
      >
        ...
        <el-table-column align="left" prop="dictValueTwoStr" width="110px" label="记录来源" :show-overflow-tooltip="true" />
        <el-table-column align="left" prop="dictValueOneStr" width="110px" label="问题类别" :show-overflow-tooltip="true" />
...
import Edit from '@/views/business/publicopinion/WorkManagement/JobAssignment/model/edit'
