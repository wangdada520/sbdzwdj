        ...
        <el-row type="flex" class="row-bg" justify="space-between">
          <el-col :span="24">
            <el-form-item
              ...
              prop="type01"
              :rules="{
                required: true, message: '请输入批示领导', trigger: 'blur'
              }"
            >
              <ChoiceUser identification="type01" flag="1" :setselection="setselection01" @returnData="returnData" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg" justify="space-between">
...
export default {
    ...
    return {
      ...
      thisform: {
        ...
        taskRecord: {
          ...
          type: '0' // 业务类型（0：领导批示，1：重点工作，2：会议纪要，3：信访，4：民意快线，5：建议提案）
        },
        type01: '',
        type02: '',
        type03: ''
  ...
  mounted() {
    ...
    this.getByDictCode('workType0', 'options1')
  },
  methods: {
    /**
     * 保存并派发
