  ...
  <div>
    ...
    >
      <el-form
        ...
        label-position="left"
      >
        <TaskDetails :taskid="form.taskId" />
...
<script>
import { addsupervisionRecord, addsupervisionCommonLanguage, getsupervisionCommonLanguagelist } from '@/views/business/api/Cuibanoverseeing'
import { parseTime } from '@/utils/index'
import { getUserName } from '@/utils/auth'
import TaskDetails from '@/views/business/meetingminutes/components/TaskDetails'
    ...
    handleOk(type) {
      this.$refs.form.validate((valid) => {
        if (valid) {
           ...
           * 整合选择的人和单位
           * */
          this.thisform['srTypeId'] = this.state
          this.thisform['srModelType'] = '2'
          this.loading = this.$loading()
          addsupervisionRecord(this.thisform).then((res) => {
