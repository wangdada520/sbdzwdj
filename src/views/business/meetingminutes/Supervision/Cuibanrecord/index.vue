  ...
  <div class="content">
    <div class="global_table_box">
      ...
      >
        ...
        <el-table-column align="center" prop="createTime" width="145px" label="催办时间" :show-overflow-tooltip="true" />
        <el-table-column align="center" prop="srUserName" width="80px" label="催办人" :show-overflow-tooltip="true" />
      </el-table>
...
import Details from '@/views/business/meetingminutes/Supervision/Cuibanrecord/model/details'
...
export default {
  ...
  methods: {
    ...
    getList(isFirstpage) {
      ...
      this.search['srTypeId'] = '1'
      this.search['srModelType'] = '2'
      const params = {
