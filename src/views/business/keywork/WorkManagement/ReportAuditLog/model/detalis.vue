  ...
  <div>
    ...
    >
      ...
      <ReportTable
        ...
        @percent="setPercent"
      >
        <AuditTable :id="form.checkId" id-name="checkId" />
      </ReportTable>
    </el-dialog>
  </div>
</template>
...
<script>
import TableHeader from '@/views/business/keywork/components/TableHeader'
import ReportTable from '@/views/business/keywork/components/ReportTable'
